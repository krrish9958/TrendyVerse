...
// request method post
        if ($_SERVER['REQUEST_METHOD'] == "POST"){
            if (isset($_POST['sproduct_submit']))
        ...
        <div class="details-container">
            ...
            <div class="details">
                ...
                <form method="post">
                    ...
                    <button class="btn" type="submit" name="sproduct_submit">Add to cart</button>
                </form>
                    ...
                    <div class="product" >
                        ...
                        <div class="product-text">
                            ...
                            <form method="post">
                                <input type="hidden" name="item_id" value="<?php echo $item['item_id'] ?? '1';?>">
                                <input type="hidden" name="user_id" value="<?php echo 1;?>">
                                <button class="btn-cart" type="submit" name="sproduct_submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
